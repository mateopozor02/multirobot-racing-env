...
class RobotAction(object):
    def __init__(self):
        ...
        self.people_sub = rospy.Subscriber('/obstacles', Obstacles, self.update_humans)
    ...
    def update_humans(self, msg):
        ...
        for p in msg.circles:
            ...
            human = Human(p.center.x, p.center.y, p.velocity.x, p.velocity.y, p.radius)
...
if __name__ == '__main__':
    ...
    model_dir = pack_path + '/CrowdNav/crowd_nav/data/output_11_f1/'
    ...
    if os.path.exists(os.path.join(model_dir, '55554.pt')):
        model_weights = os.path.join(model_dir, '55554.pt')
    else:
        model_weights = os.path.join(model_dir, '55554.pt')
