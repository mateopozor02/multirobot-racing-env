...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='data/output_alisher_blockpath_5_5')
	...
	print(args.output_dir)
        ...
        if key == 'y' and not args.resume: # remove output dir to overwrite
            shutil.rmtree(args.output_dir)
        else: # Use output config
            make_new_dir = False
            args.env_config = os.path.join(args.output_dir, os.path.basename(args.env_config)) 
            args.policy_config = os.path.join(args.output_dir, os.path.basename(args.policy_config))
            args.train_config = os.path.join(args.output_dir, os.path.basename(args.train_config))
    if make_new_dir: # make output dir and copy config to that dir.
    ...
    #l_weight_file = os.path.join(args.output_dir, 'resumed_rl_model1.pth')
    ...
    ### add logging configure!!
    logging.basicConfig(level=level, filename=log_file, handlers=[stdout_handler, file_handler],
