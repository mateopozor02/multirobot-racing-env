...
def main():
    ...
    parser.add_argument('--no', default=False, action='store_true')
    parser.add_argument('--circle_static', default=True, action='store_true')
    parser.add_argument('--square_static', default=False, action='store_true')
    ...
    if args.visualize:
        ...
        while not done:
            action = robot.act(ob)
            ob, reward, done, info, reward_values, left_path, position, is_stopped, min_wall_bool = env.step(action)
