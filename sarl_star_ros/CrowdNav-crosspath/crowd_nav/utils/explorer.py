...
class Explorer(object):
    ...
    def run_k_episodes(self, k, phase, update_memory=False, imitation_learning=False, episode=None,
        ...
        for i in range(k):
            ...
            length = 0
	    stops = 0
	    rewards_dict = {"Total Reward": 0,"R_dan": 0, "R_for": 0, "R_goal": 0,"R_col": 0,"R_km": 0, "R_col_wall": 0, "timeout": 0, "R_wall_min_dist": 0, "R_wall_max_dist": 0, "R_stop_t": 0}
	    close_points = 0
            while not done:
                ...
                ob, reward, done, info, reward_values, end_dg, position, is_stopped, min_p = self.env.step(action)
		...
		if is_stopped:
		   stops += 1
            ...
            if isinstance(info, ReachGoal):
                logging.info("%s/%s episode: Success! Total Reward: %s, R_dan: %s, R_for: %s R_goal: %s, R_col: %s, R_km: %s, R_col_wall: %s, timeout: %s, R_wall_min_dist: %s, R_wall_max_dist: %s, R_stop_t: %s" % (i + 1, k, rewards_dict["Total Reward"], rewards_dict["R_dan"], rewards_dict["R_for"], rewards_dict["R_goal"], rewards_dict["R_col"], rewards_dict["R_km"], rewards_dict["R_col_wall"], rewards_dict["timeout"], rewards_dict["R_wall_min_dist"], rewards_dict["R_wall_max_dist"], rewards_dict["R_stop_t"]))
                logging.info("Path length: %s" % length)
                logging.info("Path left: %s" % end_dg)
                logging.info("Stops: %s" % stops)
                logging.info("Position: %s, %s" % position)
                logging.info("Min close points: %s\n" % close_points)
                ...
                logging.info("%s/%s episode: Collision! Total Reward: %s, R_dan: %s, R_for: %s R_goal: %s, R_col: %s, R_km: %s, R_col_wall: %s, timeout: %s, R_wall_min_dist: %s, R_wall_max_dist: %s, R_stop_t: %s" % (i + 1, k, rewards_dict["Total Reward"], rewards_dict["R_dan"], rewards_dict["R_for"], rewards_dict["R_goal"], rewards_dict["R_col"], rewards_dict["R_km"], rewards_dict["R_col_wall"], rewards_dict["timeout"], rewards_dict["R_wall_min_dist"], rewards_dict["R_wall_max_dist"], rewards_dict["R_stop_t"]))
                logging.info("Path length: %s" % length)
                logging.info("Path left: %s" % end_dg)
                logging.info("Stops: %s" % stops)
                logging.info("Position: %s, %s" % position)
                ...
                logging.info("%s/%s episode: Timeout! Total Reward: %s, R_dan: %s, R_for: %s R_goal: %s, R_col: %s, R_km: %s, R_col_wall: %s, timeout: %s, R_wall_min_dist: %s, R_wall_max_dist: %s, R_stop_t: %s" % (i + 1, k, rewards_dict["Total Reward"], rewards_dict["R_dan"], rewards_dict["R_for"], rewards_dict["R_goal"], rewards_dict["R_col"], rewards_dict["R_km"], rewards_dict["R_col_wall"], rewards_dict["timeout"], rewards_dict["R_wall_min_dist"], rewards_dict["R_wall_max_dist"], rewards_dict["R_stop_t"]))
                logging.info("Path length: %s" % length)
                logging.info("Path left: %s" % end_dg)
                logging.info("Stops: %s" % stops)
                logging.info("Position: %s, %s" % position)
                ...
                logging.info("%s/%s episode: Collision Wall! Total Reward: %s, R_dan: %s, R_for: %s R_goal: %s, R_col: %s, R_km: %s, R_col_wall: %s, timeout: %s, R_wall_min_dist: %s, R_wall_max_dist: %s, R_stop_t: %s" % (i + 1, k, rewards_dict["Total Reward"], rewards_dict["R_dan"], rewards_dict["R_for"], rewards_dict["R_goal"], rewards_dict["R_col"], rewards_dict["R_km"], rewards_dict["R_col_wall"], rewards_dict["timeout"], rewards_dict["R_wall_min_dist"], rewards_dict["R_wall_max_dist"], rewards_dict["R_stop_t"]))
		logging.info("Path length: %s" % length)
                logging.info("Path left: %s" % end_dg)
                logging.info("Stops: %s" % stops)
                logging.info("Position: %s, %s" % position)
