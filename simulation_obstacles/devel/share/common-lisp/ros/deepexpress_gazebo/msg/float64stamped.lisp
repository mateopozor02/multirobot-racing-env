...
(cl:in-package deepexpress_gazebo-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <float64stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'float64stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepexpress_gazebo-msg:<float64stamped> is deprecated: use deepexpress_gazebo-msg:float64stamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <float64stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepexpress_gazebo-msg:header-val is deprecated.  Use deepexpress_gazebo-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <float64stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepexpress_gazebo-msg:data-val is deprecated.  Use deepexpress_gazebo-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<float64stamped>)))
  ...
  "deepexpress_gazebo/float64stamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'float64stamped)))
  "Returns string type for a message object of type 'float64stamped"
  "deepexpress_gazebo/float64stamped")
